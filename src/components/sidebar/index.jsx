...
import { customer15, logo, logoSmall, logoSmallPng, logoWhite } from "../../utils/imagepath";
const Sidebar = () => {
                          ...
                          <React.Fragment key={i}>
                            ...
                            <li
                              ...
                              <Link
                                ...
                                className={`${subOpen === title?.label ? "subdrop" : ""} ${title?.links?.includes(Location.pathname) ?
                                    "active" :
                                    ""}`
                                }>
                                            ...
                                            <li key={subIndex}>
                                              <Link
                                                ...
                                                className={`${subsidebar === items?.label ?
                                                    "submenu-two subdrop" :
                                                    "submenu-two"} ${items?.submenuItems?.
                                                    map((link) => link.link).
                                                    includes(
                                                      Location.pathname
                                                    ) ||
